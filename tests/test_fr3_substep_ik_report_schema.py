...
def test_fr3_substep_ik_targets_dry_run_schema(tmp_path):
    output = tmp_path / "substep_ik.json"
    result = subprocess.run(
        [
            sys.executable,
            "scripts/check_fr3_substep_ik_targets.py",
            "--robot-config",
    ...
    assert set(payload["actions_checked"]) == {"plus_x_5mm", "minus_x_5mm", "plus_z_5mm", "minus_z_5mm"}
